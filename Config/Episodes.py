class EpisodesParamsDouble:
    ...
    TH_D_WALL = 330  # threshold for wall
    TH_D_TABLE = 300  # threshold for table
    TH_RACKET_SANITY = 230  # threshold for two consecutive racket sanity
    TH_SUCCESS_EPISODES = 150  # threshold for success episode
    ...
    def __init__(self, type="clean_ball"):
        if type == "clean_ball":
            self.TH_CONFIDENCE = 0.5  # threshold for valleys detection
            ...
            self.TH_D_WALL = 150  # threshold for wall
            self.TH_D_TABLE = 150  # threshold for table
            self.TH_RACKET_SANITY = 230  # threshold for episode sanity
            self.TH_SUCCESS_EPISODES = 200  # threshold for success episode
